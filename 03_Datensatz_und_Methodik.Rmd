...
Abbildung 1 zeigt die Histogramme der Renditen beider Datensätze sowie in gelb die Normalverteilung und türkis die Verteilung. Beide Abbildungen bestätigen das Ergebnis der Tests. Es liegt bei beiden Abbildungen eine zu hohe Kurtosis vor, die Renditen sind leptokurtisch verteilt. Beide Histogramme zeigen eine leptokurtische Verteilung der Renditen und bestätigen somit das Ergebnis des Jarque-Bera Tests.
