...
Um die Normalverteilung der Returns zu testen, wurden pro Stichprobe jeweils der Jarque-Bera-Test durchgeführt.^[@Jarque.1980, @Jarque.1987]


<!--Durchführen des Jarque-Bera Tests auf Normalverteilung der Returns-->
```{r echo=FALSE, warning=FALSE}


# Für Age:
DescTools::JarqueBeraTest(x = tidy_return_age$prc,
                          robust = TRUE,
                          method = c("chisq", "mc"),
                          N = 0,
                          na.rm = FALSE)
...
# Für Size:
DescTools::JarqueBeraTest(x = tidy_return_size$prc,
                          robust = TRUE,
                          method = c("chisq", "mc"),
                          N = 0,
                          na.rm = FALSE)
